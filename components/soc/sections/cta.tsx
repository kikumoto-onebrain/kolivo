      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto rounded-3xl border border-white/10 bg-white/5 backdrop-blur p-8 sm:p-12">
          <div className="text-center">
            ...
            >
              Fale com um especialista em SOC e IAM
            </motion.h3>
            ...
            >
              Solicite um diagnóstico para melhorar detecção, resposta a incidentes e governança de acessos.
            </motion.p>
          </div>
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button
                ...
                className="w-full bg-kolivo-accent hover:bg-kolivo-accent/90 h-14 text-lg font-semibold transition-all duration-300 hover:shadow-[0_0_30px_rgba(90,90,255,0.5)]"
              >
              ...
              <p className="text-xs text-gray-400 text-center">
                Ao enviar, você concorda em ser contatado pela Kolivo para orientação sobre SOC e IAM.
              </p>
            </form>
          </motion.div>
        </div>
