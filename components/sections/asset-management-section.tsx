  ...
  return (
    <section id="gestao-ativos" className="py-32 bg-white overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        {/* Mantém layout original no desktop, mas ajusta no mobile */}
        <div className="flex flex-col lg:flex-row items-center justify-center gap-10 lg:gap-16 max-w-7xl mx-auto min-h-[70vh]">
          ...
          <div className="flex-1 flex flex-col justify-center gap-8 w-full mt-8 lg:mt-0">
            {features.map((feature, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="group p-10 bg-gradient-to-br from-kolivo-primary to-kolivo-blue 
                             rounded-2xl hover:shadow-[0_0_40px_rgba(90,90,255,0.3)] 
                             transition-all duration-500"
                >
                  <div className="flex items-start gap-6">
                    <div className="flex-shrink-0 inline-flex items-center justify-center 
                                    w-16 h-16 rounded-xl bg-kolivo-accent/20">
