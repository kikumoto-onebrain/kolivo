  ...
  return (
    <section id="rpa" className="py-32 bg-gradient-to-b from-white to-gray-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        {/* No mobile a ordem fica: Texto -> Cards -> Botão (mobile). No desktop, layout original. */}
        <div className="flex flex-col-reverse lg:flex-row items-center gap-16 max-w-7xl mx-auto">
          ...
          >
            ...
            {/* Botão — MOBILE: aparece depois dos cards */}
          ...
          {/* Coluna Esquerda — Título, texto e botão (desktop mantém como estava) */}
          <motion.div
            initial={{ opacity: 0, x: -40 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true, margin: '-100px' }}
          ...
          >
            ...
            {/* Botão — DESKTOP: fica na coluna de texto, escondido no mobile */}
